...
LoadingScreen::LoadingScreen() /*:anim_counter(0) */{
    Texture2D backgroundTexture = LoadTexture("../resources/GUI/backgrounds/LoadingScreen/loading_sheet.png");
...
void LoadingScreen::DrawScreen() {
    ...
    DrawTextureRec(this->getBackgroundTexture(), Rectangle{col * 1280.0f, row * 720.0f, 1280, 720}, Vector2{0.0f, 0.0f}, WHITE);
